...
ride_per_minute_blurb = '''This histogram displays the distribution of ride duration to the nearest minute. The peak of this distribution is at a ride duration of 6 minutes. The majority of rides last less than 15 minutes, likely used for commuting and general leisure travel purposes.'''
